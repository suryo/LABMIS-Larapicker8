        ...
        <div class="d-flex flex-column flex-column-fluid">
            ...
            {{-- <div class="row">
              <div class="col-lg-12 margin-tb">
                  <div class="card">
                      <div class="card-body">
                          @can("product-create")
                              <a class="btn btn-success" href="{{ route("akademik_registrasi_praktikum.create") }}"> Create New Akademik_registrasi_praktikum</a>
                          @endcan
          ...
          <div class="app-main flex-column flex-row-fluid" id="kt_app_main">
            ...
            <div class="d-flex flex-column flex-column-fluid">
              ...
              <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                  ...
                  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">REGISTRASI PRAKTIKUM LIST</h1>
                    <!--end::Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                      ...
                      <!--end::Item-->
                      <!--begin::Item-->
                      <li class="breadcrumb-item text-muted">REGISTRASI PRAKTIKUM</li>
                      <!--end::Item-->
                    </ul>
                    <!--end::Breadcrumb-->
                  </div>
              ...
              <!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++begin::Modal - Edit Akademik_registrasi_praktikum-->
              <div class="modal fade" id="kt_modal_edit_akademik_registrasi_praktikum{{ $akademik_registrasi_praktikum->id }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                  <!--begin::Modal content-->
                  <div class="modal-content">
                    ...
                    <div class="modal-header" id="kt_modal_add_akademik_registrasi_praktikum_header">
                      <!--begin::Modal title-->
                      <h2 class="fw-bold">EDIT REGISTRASI PRAKTIKUM</h2>
                      <!--end::Modal title-->
                      <!--begin::Close-->
                      <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" data-kt-akademik_registrasi_praktikums-modal-action="close">
                        <i class="ki-duotone ki-cross fs-1">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                      <!--begin::Form-->
                      {{-- {!! Form::open(array("route" => "akademik_registrasi_praktikum.update","method"=>"POST")) !!} --}}
                      {!! Form::model($akademik_registrasi_praktikum, ["method" => "PATCH","route" => ["akademik_registrasi_praktikum.update", $akademik_registrasi_praktikum->id], "enctype"=>"multipart/form-data"]) !!}
              ...
              <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                {!! Form::text("nip", $akademik_registrasi_praktikum->nip, array("placeholder" => "NIP","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
                <!--end::Input-->
              </div>
              <!--end::Input group-->
              ...
              <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                {!! Form::text("tahun", $akademik_registrasi_praktikum->tahun, array("placeholder" => "TAHUN","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
                <!--end::Input-->
              </div>
              <!--end::Input group-->
              ...
              <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                {!! Form::text("status", $akademik_registrasi_praktikum->status, array("placeholder" => "STATUS","class" => "form-control form-control-solid mb-3 mb-lg-0")) !!}
                <!--end::Input-->
              </div>
              <!--end::Input group-->
              ...
              @foreach ($data as $key => $akademik_registrasi_praktikum)
              <!--+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++begin::Modal - ShowAkademik_registrasi_praktikum-->
              <div class="modal fade" id="kt_modal_show_akademik_registrasi_praktikum{{ $akademik_registrasi_praktikum->id }}" tabindex="-1" aria-hidden="true">
                <!--begin::Modal dialog-->
                <div class="modal-dialog modal-dialog-centered mw-650px">
                  <!--begin::Modal content-->
                  <div class="modal-content">
                    ...
                    <div class="modal-header" id="kt_modal_add_akademik_registrasi_praktikum_header">
                      <!--begin::Modal title-->
                      <h2 class="fw-bold">DETAIL REGISTRASI PRAKTIKUM</h2>
                      <!--end::Modal title-->
                      <!--begin::Close-->
                      <div class="btn btn-icon btn-sm btn-active-icon-primary" data-bs-dismiss="modal" data-kt-akademik_registrasi_praktikums-modal-action="close">
                        <i class="ki-duotone ki-cross fs-1">
              ...
              <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="number" name="id" class="form-control form-control-sm form-control-solid" placeholder="id" value="{{$akademik_registrasi_praktikum->id}}" />
                <!--end::Input-->
              </div>
              <!--end::Input group-->
      ...
      <th class="min-w-125px sorting">Nip</th><th class="min-w-125px sorting">Id Praktikum</th><th class="min-w-125px sorting">Tahun</th><th class="text-center min-w-100px sorting_disabled">Action</th>
              ...
              <a href="#" class="btn btn-light btn-active-light-primary btn-flex btn-center btn-sm" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end">Actions
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                  ...
                  <div class="menu-item px-3">
                    <a class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#kt_modal_show_akademik_registrasi_praktikum{{ $akademik_registrasi_praktikum->id }}">Show</a>
                  </div>
                  <!--end::Menu item-->
                  <!--begin::Menu item-->
                  <div class="menu-item px-3">
